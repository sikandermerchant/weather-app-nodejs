...
const geoCode = (address, callback) => {
  ...
  request({
    ...
    if (error) {
      callback('Unable to connect to service!', undefined); //the callback function takes in tow arguments as seen when the geoCode function when called: error: we publish that as a string and since its an error then the second argument which is data will be undefined
